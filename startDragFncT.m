...
evalin('base','set(fig_2Dslice, ''Name'',[field_name,'' R-P T='',num2str(tval)],''NumberTitle'',''off'',''Color'',[0.0 0.0 0.0]);');
...
evalin('base','plot2d_title=title(axis_slice,[''\theta='',num2str(tval)],''Color'',''w'');');
